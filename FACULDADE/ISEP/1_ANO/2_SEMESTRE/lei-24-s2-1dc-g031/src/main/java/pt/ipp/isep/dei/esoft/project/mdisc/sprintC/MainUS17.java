...
public class MainUS17 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ExternalCSV e1 = new ExternalCSV("src/main/java/pt/ipp/isep/dei/esoft/project/mdisc/sprintC/files/us17_matrix.csv", "src/main/java/pt/ipp/isep/dei/esoft/project/mdisc/sprintC/files/us17_points_names.csv");
        ...
        Graphviz.execute(routes, allShortestPaths.get(ind3), "outMstRoutes"); // Aqui deve ser outShortestPath
        ExternalCSV.exportRoutesToCSV(allShortestPaths);
    }
}
