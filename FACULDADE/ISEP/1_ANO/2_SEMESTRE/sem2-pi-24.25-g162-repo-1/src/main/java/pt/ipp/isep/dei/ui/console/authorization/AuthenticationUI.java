...
import pt.ipp.isep.dei.ui.gui.menu.UI.AdminUI;
import pt.ipp.isep.dei.ui.gui.menu.runnable.EditorUIRunnable;
import pt.ipp.isep.dei.ui.gui.menu.runnable.PlayerUIRunnable;
...
public class AuthenticationUI implements Runnable {
    ...
    private List<MenuItem> getMenuItemForRoles() {
        ...
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_EDITOR, new EditorUIRunnable()));
        rolesUI.add(new MenuItem(AuthenticationController.ROLE_PLAYER, new PlayerUIRunnable()));
