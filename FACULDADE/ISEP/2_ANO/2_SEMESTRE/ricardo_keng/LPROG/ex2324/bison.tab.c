...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SELECAO = 3,                    /* SELECAO  */
  YYSYMBOL_JOGADOR = 4,                    /* JOGADOR  */
  YYSYMBOL_JOGO = 5,                       /* JOGO  */
  YYSYMBOL_MINUTO = 6,                     /* MINUTO  */
  YYSYMBOL_7_n_ = 7,                       /* '\n'  */
  YYSYMBOL_8_ = 8,                         /* ';'  */
  YYSYMBOL_9_ = 9,                         /* ','  */
  YYSYMBOL_YYACCEPT = 10,                  /* $accept  */
  YYSYMBOL_entrada = 11,                   /* entrada  */
  YYSYMBOL_lista_selecoes = 12,            /* lista_selecoes  */
  YYSYMBOL_selecao = 13,                   /* selecao  */
  YYSYMBOL_linha_jogadores = 14,           /* linha_jogadores  */
  YYSYMBOL_jogador_golos = 15,             /* jogador_golos  */
  YYSYMBOL_lista_golos = 16,               /* lista_golos  */
  YYSYMBOL_golos_jogo = 17                 /* golos_jogo  */
};
...
{
       0,    81,    81,    84,    86,    90,    95,    97,   101,   114,
     115,   119
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "SELECAO", "JOGADOR",
  "JOGO", "MINUTO", "'\\n'", "';'", "','", "$accept", "entrada",
  "lista_selecoes", "selecao", "linha_jogadores", "jogador_golos",
  "lista_golos", "golos_jogo", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* selecao: SELECAO linha_jogadores  */
#line 90 "bison.y"
                            {
        adiciona_selecao((yyvsp[-1].str));
    }
#line 1138 "bison.tab.c"
    break;

  case 8: /* jogador_golos: JOGADOR lista_golos '\n'  */
#line 101 "bison.y"
                             {
        if (!ultima_selecao) {
        ...
        JogadorGol *jg = procura_ou_cria_jogador(ultima_selecao, (yyvsp[-2].str));
        jg->golos += (yyvsp[-1].num);
        ultima_selecao->total_golos += (yyvsp[-1].num);
        (yyval.num) = (yyvsp[-1].num); // número de golos deste jogador
    }
#line 1153 "bison.tab.c"
    break;

  case 9: /* lista_golos: %empty  */
#line 114 "bison.y"
                  { (yyval.num) = 0; }
#line 1159 "bison.tab.c"
    break;

  case 10: /* lista_golos: lista_golos ';' golos_jogo  */
#line 115 "bison.y"
                                 { (yyval.num) = (yyvsp[-2].num) + (yyvsp[0].num); }
#line 1165 "bison.tab.c"
    break;

  case 11: /* golos_jogo: JOGO ',' MINUTO  */
#line 119 "bison.y"
                    { (yyval.num) = 1; }
