...
public class Model3Formatter implements IProposalFormatter {
    ...
    public String format(SendProposalDTO dto) {
        ...
        content.append(dto.customerName()).append("is a VIP client and Shodrone is pleased to submit for your consideration a proposal for the execution of an aerial show with drones, as described below.\n");
        ...
        content.append("Looking forward to hearing from you soon.\n\n");
